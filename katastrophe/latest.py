    ...
    if serial == 'e' or serial == 'E':
        ...
        if ',' in serial:
                    ...
                    if start < end:
                        if end < 16 and start > 0:
                            for i in xrange_(start,end+1):
                                download_torrent('https://kat.how' + torrent_href[i - 1],movies[i - 1][1], ssl)
            ...
            if int(serial) <= 15 and int(serial) >= 1: 
                download_torrent('https://kat.how' + torrent_href[int(serial) - 1],movies[int(serial) - 1][1], ssl)
            else:
...
def tv_torrent(ssl):
    ...
    if serial == 'e' or serial == 'E':
        ...
        if ',' in serial:
            ...
            if len(numbs) < 3:
                if numbs[0] != '' and numbs[1] != '' :
                    ...
                    if start < end:
                        if end < 16 and start > 0:
                            for i in xrange_(start,end+1):
                                download_torrent('https://kat.how' + torrent_href[(i+15) - 1],tv[i - 1][1], ssl)
                elif numbs[0] != '' and numbs[1] == '' :
                    start = int(numbs[0])
                    if start > 0 and start < 16:
                        for i in xrange_(start,16):
            ...
            if int(serial) <= 15 and int(serial) >= 1: 
                download_torrent('https://kat.how' + torrent_href[(int(serial) + 15) - 1],tv[int(serial) - 1][1], ssl)
            else:
                print "\n\n\tINCORRECT SERIAL, TORRRENT DOES NOT EXIST...TRY AGAIN!!\n\n"
...
def music_torrent(ssl):
    ...
    if serial == 'e' or serial == 'E':
        ...
        if ',' in serial:
            ...
            if len(numbs) < 3:
                if numbs[0] != '' and numbs[1] != '' :
                    ...
                    if start < end:
                        if end < 16 and start > 0:
                            for i in xrange_(start,end+1):
                                download_torrent('https://kat.how' + torrent_href[(i+30) - 1],music[i - 1][1], ssl)
                elif numbs[0] != '' and numbs[1] == '' :
                    start = int(numbs[0])
                    if start > 0 and start < 16:
                        for i in xrange_(start,16):
            ...
            if int(serial) <= 15 and int(serial) >= 1: 
                download_torrent('https://kat.how' + torrent_href[(int(serial) + 30) - 1],music[int(serial) - 1][1], ssl)
            else:
                print "\n\n\tINCORRECT SERIAL, TORRRENT DOES NOT EXIST...TRY AGAIN!!\n\n"
...
def games_torrent(ssl):
    ...
    if serial == 'e' or serial == 'E':
        ...
        if ',' in serial:
            ...
            if len(numbs) < 3:
                if numbs[0] != '' and numbs[1] != '' :
                    ...
                    if start < end:
                        if end < 16 and start > 0:
                            for i in xrange_(start,end+1):
                                download_torrent('https://kat.how' + torrent_href[(i+45) - 1],games[i - 1][1], ssl)
                elif numbs[0] != '' and numbs[1] == '' :
                    start = int(numbs[0])
                    if start > 0 and start < 16:
                        for i in xrange_(start,16):
            ...
            if int(serial) <= 15 and int(serial) >= 1: 
                download_torrent('https://kat.how' + torrent_href[(int(serial) + 45) - 1],games[int(serial) - 1][1], ssl)
            else:
                print "\n\n\tINCORRECT SERIAL, TORRRENT DOES NOT EXIST...TRY AGAIN!!\n\n"
...
def applications_torrent(ssl):
    ...
    if serial == 'e' or serial == 'E':
        ...
        if ',' in serial:
            ...
            if len(numbs) < 3:
                if numbs[0] != '' and numbs[1] != '' :
                    ...
                    if start < end:
                        if end < 16 and start > 0:
                            for i in xrange_(start,end+1):
                                download_torrent('https://kat.how' + torrent_href[(i+60) - 1],applications[i - 1][1], ssl)
                elif numbs[0] != '' and numbs[1] == '' :
                    start = int(numbs[0])
                    if start > 0 and start < 16:
                        for i in xrange_(start,16):
            ...
            if int(serial) <= 15 and int(serial) >= 1: 
                download_torrent('https://kat.how' + torrent_href[(int(serial) + 60) - 1],applications[int(serial) - 1][1], ssl)
            else:
                print "\n\n\tINCORRECT SERIAL, TORRRENT DOES NOT EXIST...TRY AGAIN!!\n\n"
...
def anime_torrent(ssl):
    ...
    if serial == 'e' or serial == 'E':
        ...
        if ',' in serial:
            ...
            if len(numbs) < 3:
                if numbs[0] != '' and numbs[1] != '' :
                    ...
                    if start < end:
                        if end < 16 and start > 0:
                            for i in xrange_(start,end+1):
                                download_torrent('https://kat.how' + torrent_href[(i+75) - 1],anime[i - 1][1], ssl)
                elif numbs[0] != '' and numbs[1] == '' :
                    start = int(numbs[0])
                    if start > 0 and start < 16:
                        for i in xrange_(start,16):
            ...
            if int(serial) <= 15 and int(serial) >= 1: 
                download_torrent('https://kat.how' + torrent_href[(int(serial) + 75) - 1],anime[int(serial) - 1][1], ssl)
            else:
                print "\n\n\tINCORRECT SERIAL, TORRRENT DOES NOT EXIST...TRY AGAIN!!\n\n"
...
def books_torrent(ssl):
    ...
    if serial == 'e' or serial == 'E':
        ...
        if ',' in serial:
            ...
            if len(numbs) < 3:
                if numbs[0] != '' and numbs[1] != '' :
                    ...
                    if start < end:
                        if end < 16 and start > 0:
                            for i in xrange_(start,end+1):
                                download_torrent('https://kat.how' + torrent_href[(i+90) - 1],books[i - 1][1], ssl)
                elif numbs[0] != '' and numbs[1] == '' :
                    start = int(numbs[0])
                    if start > 0 and start < 16:
                        for i in xrange_(start,16):
            ...
            if int(serial) <= 15 and int(serial) >= 1: 
                download_torrent('https://kat.how' + torrent_href[(int(serial) + 90) - 1],books[int(serial) - 1][1], ssl)
            else:
                print "\n\n\tINCORRECT SERIAL, TORRRENT DOES NOT EXIST...TRY AGAIN!!\n\n"
...
def losslessmusic_torrent(ssl):
    ...
    if serial == 'e' or serial == 'E':
        ...
        if ',' in serial:
            ...
            if len(numbs) < 3:
                if numbs[0] != '' and numbs[1] != '' :
                    ...
                    if start < end:
                        if end < 16 and start > 0:
                            for i in xrange_(start,end+1):
                                download_torrent('https://kat.how' + torrent_href[(i+105) - 1],losslessmusic[i - 1][1], ssl)
                elif numbs[0] != '' and numbs[1] == '' :
                    start = int(numbs[0])
                    if start > 0 and start < 16:
                        for i in xrange_(start,16):
            ...
            if int(serial) <= 15 and int(serial) >= 1: 
                download_torrent('https://kat.how' + torrent_href[(int(serial) + 105) - 1],losslessmusic[int(serial) - 1][1], ssl)
            else:
                print "\n\n\tINCORRECT SERIAL, TORRRENT DOES NOT EXIST...TRY AGAIN!!\n\n"